---
description: "Business-ready delivery summary from completed stories."
---
...
Create `.specify/specs/NNN-feature-name/RELEASE_NOTES.md` using the following structure:
